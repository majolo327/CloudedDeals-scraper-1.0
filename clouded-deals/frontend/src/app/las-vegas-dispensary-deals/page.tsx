...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes, CloudedDeals is completely free. No account needed. We check every dispensary every morning and find only the deals worth your money — no sponsored placements.',
  },
];
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mb-6">
            We check every dispensary in Las Vegas every morning and find only the deals worth your money.
