...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    category: 'comparison',
    heroSubtitle:
      'We compare every dispensary every morning. Only the best prices make it here.',
    sections: [
      {
    ...
    sections: [
      {
        ...
        content: [
          ...
          'Popular deals sell out by early afternoon, especially on weekends. CloudedDeals solves this by comparing every dispensary menu at 8 AM PT, every single day. By the time you wake up, today\'s deals are already compared, scored, and ready to browse.',
        ],
        links: [
      ...
      },
      {
        ...
        content: [
          'Deals vary every day, so there\'s no "always cheapest" option. What you can do is check each category page for today\'s current prices and top-scoring brands. Every category page shows live data from this morning\'s update.',
        ],
        links: [
          { text: 'Flower deals', href: '/deals/flower' },
          { text: 'Vape deals', href: '/deals/vapes' },
