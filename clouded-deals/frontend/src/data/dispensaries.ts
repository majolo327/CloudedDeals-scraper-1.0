...
export const DISPENSARIES: Dispensary[] = [
  ...
  listed('cookies-strip',         'Cookies - Strip',                   '2307 S Las Vegas Blvd',                        'strip'),
  listed('cookies-flamingo',      'Cookies - Flamingo',                '4240 W Flamingo Rd, Suite 100',                'strip'),
  ...
  listed('green-hualapai',        'Green - Hualapai',                  '4510 S Hualapai Way',                          'local'),
  listed('green-eastern',         'Green - Eastern',                   '10420 S Eastern Ave, Suite 100',               'local'),
  listed('green-rainbow',         'Green - Rainbow',                   '101 S Rainbow Blvd, Suite 1-5',               'local'),
  listed('the-grove-basin',       'The Grove - Basin',                 '1541 E Basin Ave',                             'local'),
  listed('the-grove-strip',       'The Grove - Strip',                 '1600 S Las Vegas Blvd, Suite 150',             'strip'),
  listed('inyo',                  'Inyo Fine Cannabis',                '2520 S Maryland Pkwy, Suite 2',                'strip'),
  listed('jade-desert-inn',       'Jade Cannabis - Desert Inn',        '1130 E Desert Inn Rd',                         'strip'),
  listed('jade-skypointe',        'Jade Cannabis - Sky Pointe',        '6050 Sky Pointe Ave, Suite 150',               'local'),
  listed('jardin',                'Jardin',                            '2900 E Desert Inn Rd, Suite 102',              'strip'),
  listed('jennys',                'Jenny\'s Dispensary',               '5530 N Decatur Blvd',                          'local'),
  // LivFree Wellness removed — legal license name for The Dispensary (TD Gibson), not a standalone store
  listed('nv-made-cactus',        'Nevada Made - Cactus',              '1675 E Cactus Ave',                            'local'),
  listed('nv-made-charleston',    'Nevada Made - E Charleston',        '3915 E Charleston Blvd',                       'local'),
  listed('nv-made-warm-springs',  'Nevada Made - Warm Springs',        '95 E Warm Springs Rd',                         'local'),
  listed('nv-made-w-charleston',  'Nevada Made - W Charleston',        '7650 W Charleston Blvd',                       'local'),
  ...
  d('rise-sunset',    'RISE Henderson (Sunset)', 'standard', '4300 E Sunset Rd, Suite A2-A3',  'local', 'jane', 'https://risecannabis.com/dispensaries/nevada/henderson/887/pickup-menu/',                36.0721, -115.0621),
  d('rise-tropicana', 'RISE Tropicana',          'standard', '5765 W Tropicana Ave',           'strip', 'jane', 'https://risecannabis.com/dispensaries/nevada/las-vegas-west-tropicana/886/pickup-menu/', 36.0993, -115.2245),
  d('rise-rainbow',   'RISE Rainbow',            'standard', '7260 S Rainbow Blvd, Suite 104', 'local', 'jane', 'https://risecannabis.com/dispensaries/nevada/las-vegas-south-rainbow/1718/pickup-menu/', 36.0565, -115.2437),
  d('rise-nellis',    'RISE Nellis',             'standard', '871 N Nellis Blvd, Suite 9',     'local', 'jane', 'https://risecannabis.com/dispensaries/nevada/las-vegas-nellis/5267/pickup-menu/',        36.1755, -115.0628),
  d('rise-boulder',   'RISE Henderson (Boulder)','standard', '1000 S Boulder Hwy',             'local', 'jane', 'https://risecannabis.com/dispensaries/nevada/henderson-boulder/6211/pickup-menu/',       36.1512, -114.9816),
  d('rise-durango',   'RISE Durango',            'standard', '6410 S Durango Dr',              'local', 'jane', 'https://risecannabis.com/dispensaries/nevada/las-vegas-south-durango/1885/pickup-menu/', 36.0643, -115.2790),
  d('rise-craig',     'RISE Craig',              'standard', '3930 W Craig Rd, Suite 101-104', 'local', 'jane', 'https://risecannabis.com/dispensaries/nevada/las-vegas-craig-rd/5429/pickup-menu/',      36.2358, -115.2007),
  listed('sahara-wellness',       'Sahara Wellness',                   '420 E Sahara Ave',                             'strip'),
  listed('sanctuary-3rd',         'The Sanctuary - 3rd St',            '1324 S 3rd St',                                'downtown'),
  listed('sanctuary-lv-blvd',     'The Sanctuary - LV Blvd',           '2113 N Las Vegas Blvd',                        'local'),
  ...
  listed('the-source-eastern',    'The Source - Eastern',              '9480 S Eastern Ave, Suite 185 & 190',          'local'),
  listed('the-source-rainbow',    'The Source - Rainbow',              '2550 S Rainbow Blvd',                          'local'),
  listed('the-source-deer-springs','The Source - Deer Springs',        '420 E Deer Springs Way, Suite 100',            'local'),
  listed('the-source-homestead',  'The Source - Homestead',            '2370 & 2380 Homestead Rd',                     'local'),
  listed('thrive-cactus',         'Thrive - Cactus',                   '3698 W Cactus Ave, Suite 107-109',             'local'),
  listed('top-notch',             'Top Notch THC',                     '5630 Stephanie St',                            'local'),
  listed('treehouse',             'The Treehouse Vegas',               '4660 S Decatur Blvd',                          'local'),
  listed('tree-of-life-jones',    'Tree of Life - Jones',              '1437 N Jones Blvd',                            'local'),
  listed('tree-of-life-centennial','Tree of Life - Centennial',        '150 E Centennial Pkwy, Suite 114',             'local'),
  listed('wallflower-bd',         'Wallflower - Blue Diamond',         '6540 Blue Diamond Rd',                         'local'),
  listed('wallflower-volunteer',  'Wallflower - Volunteer',            '3485 Volunteer Blvd',                          'local'),
];
