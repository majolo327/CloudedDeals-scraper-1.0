-- =========================================================================
-- 043_fix_dashboard_array_length.sql — Hotfix: deploy all 4 dashboard RPCs
-- =========================================================================
-- The admin dashboard broke with:
--   "function array_length(jsonb, integer) does not exist"
--
-- Root cause: migration 040 used array_length() on JSONB columns
-- (sites_scraped, sites_failed). PostgreSQL's array_length() only works
-- on native arrays; JSONB arrays need jsonb_array_length().
--
-- Migrations 041/042 fixed this but were never applied to the database.
-- This migration is a standalone re-deployment of all 4 optimized RPCs
-- from 042 — safe to run multiple times (CREATE OR REPLACE).
-- =========================================================================

-- =========================================================================
-- 1. get_dashboard_growth(window_days) — single-scan user/engagement metrics
-- =========================================================================
...
-- =========================================================================
-- 2. get_dashboard_retention(window_days) — retention & engagement metrics
-- =========================================================================
...
-- =========================================================================
-- 3. get_dashboard_cohorts() — weekly cohort retention table
-- =========================================================================
...
-- =========================================================================
-- 4. get_dashboard_pipeline() — scraper pipeline, coverage, viral metrics
-- =========================================================================
-- KEY FIX: Uses jsonb_array_length() (not array_length()) because
-- scrape_runs.sites_scraped and sites_failed are JSONB, not native arrays.
-- =========================================================================
